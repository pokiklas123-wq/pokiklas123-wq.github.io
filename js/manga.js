            ...
            <div class="manga-header">
                ...
                <div class="manga-info-large">
                    ...
                    <div class="manga-description">
                        <p>${this.mangaData.description || `استمتع بقراءة ${this.mangaData.name} بأفضل جودة. يمكنك قراءة جميع الفصول مجاناً.`}</p>
                    </div>
                </div>
            </div>
    ...
    prepareChaptersList() {
        ...
        return Object.keys(this.mangaData.chapters)
            .map(key => {
                ...
                const chapterData = this.mangaData.chapters[key];
                return {
                    number: chapterNum,
                    key: key,
