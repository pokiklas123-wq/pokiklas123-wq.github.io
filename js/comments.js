...
header {
    ...
    top: 0;
    z-index: 1000;
    box-shadow: 0 2px 20px rgba(26, 115, 232, 0.2);
...
/* تصميم جديد لقسم المستخدم في الدراور */
.user-profile {
    text-align: center;
    padding: 15px;
    background: var(--card-bg);
...
/* إزالة أزرار الإعجاب والمشاركة من أعلى الفصل */
.chapter-actions {
    display: none; /* إخفاء قسم الإجراءات */
}
...
:root[data-theme="light"] .reply-input,
:root[data-theme="light"] .edit-comment-input {
    background: #ffffff;
...
:root[data-theme="light"] .comment-input:focus,
:root[data-theme="light"] .search-input:focus,
:root[data-theme="light"] .reply-input:focus,
:root[data-theme="light"] .edit-comment-input:focus {
    border-color: var(--accent-color);
    box-shadow: 0 0 0 2px rgba(26, 115, 232, 0.2);
}
...
/* إصلاح أيقونة تبديل الردود */
.toggle-icon {
    transition: transform 0.3s ease;
    font-size: 0.8rem;
}

/* تحسينات إضافية للدراور */
